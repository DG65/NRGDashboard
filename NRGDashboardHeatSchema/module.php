...
class NRGDashboardHeatSchema extends IPSModule
{
    ...
    public function Create()
    {
        ...
        IPS_SetVariableProfileAssociation('NRGDASHHEAT.FlowStyle', 4, 'Digitale Signalimpulse', '', -1);
    ...
    public function ApplyChanges()
    {
        ...
        if (IPS_GetKernelRunlevel() === KR_READY) {
            $this->RegisterHook('/hook/nrgdashheatschema' . $this->InstanceID);
        } else {
     ...
     * Popup oder jeden Browser). Aufruf: /hook/nrgdashheatschema<InstanzID>.
        ...
        if (!@$this->ReadAttributeBoolean(self::ATTR_REVIEW_HINT_GONE)) {
            $form['elements'][] = [
                ...
                'items' => [
                    ...
                    ['type' => 'Button', 'caption' => 'Nicht mehr anzeigen', 'onClick' => 'NRGDASHHEAT_DismissReviewHint($id);'],
                ],
            ];
        }
    ...
    private function newsBanner(): ?array
    {
        ...
        $items[] = ['type' => 'Button', 'caption' => 'Verstanden – nicht mehr anzeigen', 'onClick' => 'NRGDASHHEAT_AckNews($id);'];
