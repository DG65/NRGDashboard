...
class NRGDashboardTile extends IPSModule
{
    ...
    // dort), gruppiert nach Version. Die alte, ueber viele Releases gewachsene
    // Liste bleibt als EIN Eintrag unter ihrer letzten Vergabe ('0.9.33')
    // erhalten statt sie nachtraeglich (und unzuverlaessig) pro Zeile einer
    // Version zuzuordnen - neue Eintraege ab jetzt bekommen ihre EIGENE
    // Versionsnummer als Schluessel.
    private const NEWS_VERSIONS = [
        ...
        '0.9.73' => [
            'Neu: Quoten-Knopf oben links zeigt Autarkiegrad und Eigenverbrauchsquote als zwei Apple-Watch-artige Ringe für heute - Klick öffnet eine Tabelle mit beiden Werten für Tag, Monat, Jahr und Gesamt. Löst den bisherigen Autarkiegrad-Bogen am Haus-Knoten ab, der nur "heute" konnte.',
     ...
     *  - Vergleichsbasis fuer NEWS_VERSIONS, damit z.B. "0.9.73" (Schluessel)
     *  und "0.9.73-beta.1" (soeben bestaetigte Bibliotheksversion) als GLEICH
     *  gelten statt "-beta.1" faelschlich als "neuer" zu werten. */
    ...
    private const SELF_MODULE_GUID = '{6B2F8C41-9E3A-4D6B-8F1C-5A7D9E2B4C61}';
